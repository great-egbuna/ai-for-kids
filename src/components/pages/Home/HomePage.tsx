  ...
  return (
    <div className="min-h-screen text-white font-inter pb-[78px] relative">
      ...
      <main className="text-center px-4 md:px-12 relative z-10">
        <h1
          className="text-6xl md:text-8xl font-extrabold tracking-wide mt-10 text-cyan-300 max-w-[400px] mx-auto text-center"
          style={{
            textShadow: "0 2px 0 #007ea7, 0 4px 0 #005f7f, 0 6px 0 #003f57",
          }}
        >
          {content?.heroTitle || " AI CODING 4 KIDS"}
        </h1>
        <p
